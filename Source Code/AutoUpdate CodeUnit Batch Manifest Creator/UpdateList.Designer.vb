...
Partial Class UpdateList
    ...
    Private Sub InitializeComponent()
        ...
        Me.Label2.Text = "You can select which projects to generate a manifest for by selecting the folders" & _
            " you wish to include in the operation."
        '
        'Label1
        '
        ...
        Me.Label1.Text = "Select the Manifests to Create:"
        '
        'SplitContainer2
        '
