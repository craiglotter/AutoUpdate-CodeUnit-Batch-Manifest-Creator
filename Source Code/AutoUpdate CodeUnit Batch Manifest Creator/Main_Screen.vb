...
Public Class Main_Screen
    ...
    Dim apptorun As String = """" & Application.StartupPath & "\AutoUpdate Manifest Creator.exe"" "
    Dim filelist As ArrayList

    Dim currentprojectname As String = ""
    Dim updatelist1 As UpdateList
        ...
        Try
            If FolderBrowserDialog1.ShowDialog() = Windows.Forms.DialogResult.OK Then
                ...
                If FolderBrowserDialog2.ShowDialog() = Windows.Forms.DialogResult.OK Then
                    SaveFileDialog1.FileName = (FolderBrowserDialog2.SelectedPath & "\manifest.xml").Replace("\\", "\")
    ...
    Private Sub backgroundWorker1_DoWork(ByVal sender As Object, ByVal e As DoWorkEventArgs) Handles BackgroundWorker1.DoWork
        Try
            ...
            Dim di As DirectoryInfo = New DirectoryInfo(FolderBrowserDialog1.SelectedPath)
            For Each dinfo As DirectoryInfo In di.GetDirectories()
                If cancel_operation = True Then
                    dinfo = Nothing
                    Exit For
                End If
                updatelist1.AddProject(dinfo.Name)
                dinfo = Nothing
            Next
            di = Nothing
            Me.TopMost = False
            If cancel_operation = False Then
                If updatelist1.ShowDialog() = Windows.Forms.DialogResult.OK Then
                    ...
                    If worker.CancellationPending Then
                        ...
                        cancel_operation = True
                    End If
                    currentprojectname = FolderBrowserDialog1.SelectedPath
    ...
    Private Sub backgroundWorker1_RunWorkerCompleted(ByVal sender As Object, ByVal e As RunWorkerCompletedEventArgs) Handles BackgroundWorker1.RunWorkerCompleted
        Try
            ...
            ElseIf e.Cancelled Then
                ...
                End If
                Me.Label4.Text = "Operation was Cancelled"
            Else
                ...
                End If
                Me.Label4.Text = Me.Label4.Text & " (Operation Complete)"
    ...
    Private Sub backgroundWorker1_ProgressChanged(ByVal sender As Object, ByVal e As ProgressChangedEventArgs) Handles BackgroundWorker1.ProgressChanged
        Try
            Me.Label2.Text = currentprojectname
    ...
    Private Sub FileRunner(ByVal worker As BackgroundWorker, ByVal e As DoWorkEventArgs, ByVal currentdir As DirectoryInfo)
        Try
            ...
            For Each dinfo As DirectoryInfo In currentdir.GetDirectories()
                ...
                currentprojectname = dinfo.FullName
                If precount_max > 0 Then
                    percentComplete = CSng(currentcount) / CSng(precount_max) * 100
                Else
                    percentComplete = 100
                ...
                If updatelist1.CheckProjectStatus(dinfo.Name) = True Then
                    If dinfo.Name.LastIndexOf("-") <> -1 Then
                        If My.Computer.FileSystem.DirectoryExists(dinfo.FullName & "\Source Code\" & dinfo.Name.Substring(0, dinfo.Name.LastIndexOf("-") - 1).Trim() & "\Required Files") = True Then
                            DosShellCommand(apptorun & """" & dinfo.FullName & "\Source Code\" & dinfo.Name.Substring(0, dinfo.Name.LastIndexOf("-") - 1).Trim() & "\Required Files"" """ & SaveFileDialog1.FileName & """ """ & dinfo.Name.Substring(0, dinfo.Name.LastIndexOf("-") - 1).Trim() & """")
                            Dim tempinfo As FileInfo = New FileInfo(SaveFileDialog1.FileName)
                            My.Computer.FileSystem.MoveDirectory((tempinfo.DirectoryName & "\" & dinfo.Name.Substring(0, dinfo.Name.LastIndexOf("-") - 1).Trim() & " Manifest").Replace("\\", "\"), (tempinfo.DirectoryName & "\" & dinfo.Name.Substring(0, dinfo.Name.LastIndexOf("-") - 1).Trim()).Replace("\\", "\"), False)
                        End If
                    End If
                End If
                currentprojectname = dinfo.FullName
            ...
            If My.Computer.FileSystem.FileExists(configfile) Then
                ...
                While reader.Peek <> -1
                    ...
                    If lineread.IndexOf("=") <> -1 Then
                        ...
                        If lineread.StartsWith("LastFolder2=") Then
                            Dim dinfo As DirectoryInfo = New DirectoryInfo(variablevalue)
                            If dinfo.Exists Then
                                FolderBrowserDialog2.SelectedPath = variablevalue
                            End If
                            dinfo = Nothing
                        End If
                    End If
    ...
    Private Sub SaveSettings()
        Try
            ...
            If FolderBrowserDialog1.SelectedPath.Length > 0 Then
                ...
                dinfo = Nothing
            End If
            If FolderBrowserDialog2.SelectedPath.Length > 0 Then
                Dim dinfo As DirectoryInfo = New DirectoryInfo(FolderBrowserDialog2.SelectedPath)
                If dinfo.Exists Then
                    writer.WriteLine("LastFolder2=" & FolderBrowserDialog2.SelectedPath)
                End If
                dinfo = Nothing
            End If
